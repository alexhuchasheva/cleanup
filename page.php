...
<div class="container features">
    ...
    <div class="row">
        <div class="col-sm-3">
            <img src="http://localhost/cleanup/wp-content/uploads/2018/09/feature-clock.png" alt="clock">
            <p>Работаем<br>
                качественно<br>
                и быстро</p>
        </div>
        <div class="col-sm-3">
            <img src="http://localhost/cleanup/wp-content/uploads/2018/09/feature-cleaner.png" alt="clock">
            <p>Используем <br>
                профессиональное <br>
                оборудование </p>
        </div>
        <div class="col-sm-3">
            <img src="http://localhost/cleanup/wp-content/uploads/2018/09/feature-flower.png" alt="clock">
            <p>Гарантируем<br>
                чистоту на 100%</p>
        </div>
        <div class="col-sm-3">
            <img src="http://localhost/cleanup/wp-content/uploads/2018/09/feature-calendar.png" alt="clock">
            <p>Приходим, <br>
                когда удобно Вам</p>
        </div>
...
<div class="container cleaning-path">
    <h2>Чистота Вашей квартиры - наша забота</h2>
    <div class="col-sm-4"> <a href="http://localhost/cleanup/podderzhivajushhaja-uborka/"><img class="cleaning-first" src="http://localhost/cleanup/wp-content/uploads/2018/09/uborka-1.jpg" alt="Поддерживающая уборка"></a></div>
    <div class="col-sm-4"><a href="http://localhost/cleanup/generalnaja-uborka/"><img class="cleaning-bottom" src="http://localhost/cleanup/wp-content/uploads/2018/09/uborka-3.jpg" alt="Генеральная уборка"></a></div>
    <div class="col-sm-4"><a href="http://localhost/cleanup/uborka-posle-remonta/"><img class="cleaning-third" src="http://localhost/cleanup/wp-content/uploads/2018/09/uborka-2.jpg" alt="Уборка после ремонта"></a></div>
</div>
...
<div class="container about-us">
    <h2>О нас</h2>
<div class="row">
    <div class="col-sm-5"><img src="http://localhost/cleanup/wp-content/uploads/2018/09/blue-flowers-creative-ideas1-2.jpg" alt="flower"></div>
    <div class="col-sm-7">
